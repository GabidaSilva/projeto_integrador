function calcularIdadeHumana() {
    ...
    const idadeHumanaSpan = document.getElementById('idade-humana');
  
    const idadeconversao = {
    ...
    let idadeHumana = idadeconversao[peso][idade - 5] || "Idade não disponível";
    
   idadeHumanaSpan.innerText = idadeHumana;
  }
